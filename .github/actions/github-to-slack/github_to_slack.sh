...
function set_slack_user() {
    ...
    EMAIL_TO_SLACK_ID_MAP["burak.sezer.developer@gmail.co"]="<@U02R5QY4U8Y> | @BurakSezer"
    EMAIL_TO_SLACK_ID_MAP["buraksekili@gmail.com"]="<@U02P6G92FDJ> | @BurakSekili"
    ...
    EMAIL_TO_SLACK_ID_MAP["jeffy.mathew100@gmail.com"]="<@U02DYVB0NVC> | @Jeff"
    EMAIL_TO_SLACK_ID_MAP["1618778+joshblakeley@users.noreply.github.com"]="<@U6XQR9JFQ> | @JoshBlakeley"
    ...
    EMAIL_TO_SLACK_ID_MAP["long@tyk.io "]="<@U0359SK5V2M> | @Long Le"
    EMAIL_TO_SLACK_ID_MAP["odukoyaonline@gmail.com"]="<@U03PUTZUQ4S> | @Ola"
