...
describe('jiraAPI', () => {
  ...
  it('should throw error if JIRA_TOKEN or JIRA_USER_EMAIL is not set', async () => {
    delete process.env.JIRA_TOKEN;
    await expect(jiraAPI('/test')).rejects.toThrow('JIRA_TOKEN and JIRA_USER_EMAIL must be set');
